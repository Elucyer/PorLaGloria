...
| 2025 | UAE Team Emirates | **Tour de France 1.º** (3 etapas). **Il Lombardia 1.º** (5.º consecutivo real; *en la novela es su 3.ª — Santi ganó 2021 y 2023 — y la gana con Evenepoel 2.º y Santi 3.º en la carrera del regreso, cap. 264*). **Liège-Bastogne-Liège 1.º**. Strade Bianche 1.º. **Campeón del Mundo en ruta 2025 (Kigali)**. Criterium du Dauphiné (general). *En la novela, al final del Lombardia: la conversación con Santi en Como — la declaración de guerra del Tour 2026.* |
| 2026 | UAE Team Emirates | **Líder del ranking UCI** con amplio margen (+10.000 puntos a mitad de año). Sigue dominando clásicas y campeonatos. *(En la novela `[FICCIÓN]`: Tour de France 2026 — 2.º, detrás de Vingegaard, con del Toro 3.º. No corre la Vuelta — Santi 3.º, ajustado desde 4.º, cap. 273-274)* |
...
| 2026 | Visma-Lease a Bike | **2.º en el ranking UCI** a mitad de año, segundo mejor del pelotón tras Pogačar. Gana Paris-Niza. `[FICCIÓN, cap. 273-274: gana el Tour de France 2026 — su segundo Tour — esperando a que Pogačar y del Toro se desgasten peleando etapas, y atacando en los Alpes cuando ninguno de los dos tenía nada más para responder. No cruza con Santi, que corre la Vuelta, no el Tour.]` |
...
| 2025 | Soudal–QS | Continúa en el circuito WorldTour con foco en clásicas y Grand Tours. **Il Lombardia 2.º** (real, detrás de Pogačar). *En la novela: ese 2.º es por delante de Santi 3.º en la carrera del regreso (cap. 264) — y la prensa, obsesionada con "el reencuentro de los dos titanes", lo relega a nota al pie en su propio podio. El agravio narrativo que alimenta su Tour 2026.* |
| 2026 | Soudal–QS | Top 10 del ranking UCI a mitad de año, detrás de Pogačar, del Toro y Vingegaard. Sigue siendo amenaza en CRI y montaña corta. `[FICCIÓN]` Cuarto hombre de la guerra del Tour 2026 (Santi–Pogačar–Vingegaard–Evenepoel) — ver `MAPA_Capitulos_Arco_V.md`. |
...
**Nota narrativa:** Evenepoel y Santi tienen exactamente la misma edad (nacidos en 2000). El contraste entre los dos — el belga mediático, extrovertido, producto de un sistema; el colombiano reservado, forjado en los puertos de Antioquia — puede ser un hilo narrativo en los arcos tardíos. **Detalle espejo (canon revisado):** Remco sabe lo que es volver de una lesión grave — se rompió la pelvis cayendo *precisamente en Il Lombardia* (2020). Que el regreso de Santi ocurra en esa misma carrera, y que Remco le termine por delante, es un eco deliberado que la novela puede explotar sin subrayarlo.
...
| 2026–2033 | MercadoLibre-FCV | `[FICCIÓN]` **Fichado por el equipo de Santi en el invierno 2025-26** como pieza del superequipo del Tour 2026: motor de crono, llano, abanicos y crono por equipos. Ver `MAPA_Capitulos_Arco_V.md` y `PERFILES_Corredores.md`. |

**Nota narrativa:** Ganna es la encarnación del problema que persigue a Santi durante toda la carrera — "la crono, siempre la crono" (cap. 146). Durante años, "el modelo Ganna" fue la vara con que Rusconi y Ferretti medían lo que Santi nunca iba a ser contra el reloj. **El giro del canon revisado:** no pudieron fabricarlo, así que lo compraron — desde 2026, la vara pedalea al lado de Santi.
...
**Nota narrativa:** Del Toro es tres años más joven que Santi (nacido 2003 vs. 2000) y corre para el mismo equipo que Pogačar (UAE Team Emirates) — es su compañero, no su rival directo, así que cualquier escena de Tour o Giro debe mostrarlo como gregario de lujo al que el equipo da libertad puntual para atacar cuando la general ya está controlada, nunca disputándole la carrera a Pogačar de frente. Es el nombre obvio para sembrar como "la próxima generación que ya está llegando" durante el Arco V — la prueba de que el reloj de Santi también corre para los que vienen detrás, no solo para los rivales de su misma edad (Pogačar, Vingegaard, Remco). **Beat fijado para el Tour 2026** (los capítulos del plan viejo fueron eliminados; el beat se conserva en `MAPA_Capitulos_Arco_V.md`): gana una etapa de los Pirineos con permiso de Pogačar mientras este último vigila a Vingegaard, y le escribe a Santi por primera vez (Pogačar le pasó el contacto). Reservar su arco de rivalidad mayor con Santi para el Arco VI, cuando Santi ya sea el veterano frente a él y del Toro probablemente ya sea líder propio en otro equipo.

### Paul Seixas
**Nacido:** 24/09/2006 — Lyon, Francia
**Equipo:** Decathlon CMA CGM Team (antes Decathlon AG2R, 2025–)

El fenómeno más joven del pelotón — seis años menor que Santi. Campeón del mundo júnior de contrarreloj (2024, con 17 años). Debutó en el WorldTour en 2025 y, ese mismo año, fue el corredor más joven de la historia en terminar entre los 10 primeros de una carrera por etapas WorldTour (Critérium du Dauphiné). Ganó también el Tour de l'Avenir 2025. **2026, su año de explosión definitiva [REAL, verificado]:** victoria de etapa + 2.º general en la Volta ao Algarve (19 de febrero, por delante de Almeida y Ayuso); victoria solitaria en la Faun-Ardèche Classic (28 de febrero, fuga de más de 40 km); único corredor capaz de seguir el ataque de 79 km de Pogačar en la Strade Bianche (7 de marzo), terminando 2.º; ganador de la Flèche Wallonne (Mur de Huy), recuperándose de una caída a mitad de carrera; **ganador de la clasificación general de la Itzulia País Vasco**. Seis victorias profesionales a los diecinueve años. Descrito por la prensa especializada como "el próximo gran talento" del ciclismo francés — con un perfil completo, fuerte en crono (algo que ni Pogačar ni Santi tuvieron de forma natural a esa edad).

**Nota narrativa:** Seixas es demasiado joven para ser rival directo de Santi en el Arco V (tendría 20-22 años en 2026-2028, recién llegando al WorldTour), pero es el nombre perfecto para que Hernando o Rusconi mencionen de pasada como advertencia: "ya viene otro, y este sí sabe rodar contra el crono desde los diecisiete." Útil como espejo inverso de la propia debilidad histórica de Santi en la contrarreloj — el francés tiene, de fábrica, lo que a Santi le costó años de túnel de viento construir. **Beat conservado del plan viejo** (los capítulos fueron eliminados): gana la Itzulia País Vasco 2026 `[REAL]`; integrarlo en la primavera 2026 del nuevo plan con un breve intercambio entre Santi y Rusconi sobre la nueva generación.
...
*Revisado 14 de julio de 2026 — **canon revisado del regreso**: Lombardia 2025 in-novel (Pogačar 1.º/3.ª suya, Evenepoel 2.º, Santi 3.º en el regreso), agravio narrativo de Remco sembrado en Como, Ganna fichado por MercadoLibre-FCV para 2026, beats de del Toro y Seixas desanclados de los capítulos eliminados del plan viejo del Arco V (266-279). Ver `MAPA_Capitulos_Arco_V.md` reescrito.*
